 ...
 * 
 * @example
 * <EvidenceIndicator evidenceCount={5} />
 */
const EvidenceIndicator: React.FC<EvidenceIndicatorProps> = ({
  evidenceCount,
  size = 'sm',
  className = '',
}) => {
  ...
  return (
    <div className={`flex items-center justify-center gap-1 mt-1 ${className}`}>
      {evidenceCount === 1 ? (
        <div
