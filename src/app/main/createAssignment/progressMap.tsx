...
const ProgressMap = () => {
  ...
  const [selectedUnit, setSelectedUnit] = useState(
    learner?.course &&
      learner.course?.length > 0 &&
      learner.course[0]?.units &&
      learner.course[0].units?.length > 0
        ...
        <CardContent>
          ...
          <div className='grid grid-cols-2 gap-5'>
            <Typography variant='body1'>
              <strong>Name:</strong> {learner?.first_name} {learner?.last_name}
            </Typography>
            <Typography variant='body1'>
              <strong>Username:</strong> {learner?.user_name}
            </Typography>
          </div>
          <div className='grid grid-cols-2 gap-5'>
            <Typography variant='body1'>
            ...
            <Typography variant='body1'>
              <strong>Mobile:</strong> {learner?.mobile}
            </Typography>
          </div>
        </CardContent>
      </Card>
                  ...
                  <TableCell align='center'>
                    <div className={styles.gap}>
                      <div
                        style={{
                          backgroundColor:
                            subUnit.learnerMap && subUnit.trainerMap
                              ? 'green'
                              : subUnit.learnerMap || subUnit.trainerMap
                              ? 'orange'
                              : 'maroon',
