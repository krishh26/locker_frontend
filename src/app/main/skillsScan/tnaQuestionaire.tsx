...
function getQuarterlyDates(startDateStr) {
  const result = []
...
const TNAQuestionaire = (props) => {
  ...
  useEffect(() => {
    if (courseData.operational_start_date) {
      setReviewDates(getQuarterlyDates(courseData.operational_start_date))
    }
  }, [courseData])
                  ...
                  >
                    ...
                    <TableCell
                      ...
                      sx={{
                        ...
                        width: '1%',
                        backgroundColor:
                          highlightBlanks && row.rating == null
                            ? 'yellow'
                            : 'inherit',
                      }}
                    >
                      <Radio
                        checked={row?.rating === 1}
